...
void Swapchain::SetWaitableObject(HANDLE waitableObj)
{
  m_frameLatencyWaitableObj = waitableObj;
}
void Swapchain::WaitOnSwapchain()
{
  WaitForSingleObjectEx(m_frameLatencyWaitableObj, 1000, true);
}
